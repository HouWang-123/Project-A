...
public static class UtilityBuiltin
{
    ...
    public static class AssetsPath
    {
        ...
        {
            return Utility.Text.Format("Assets/DataTable/{0}.txt", name);
        }

        public static string GetSoundPath(string name)
        {
            return Utility.Text.Format("Assets/Audio/{0}", name);
        }

        public static string GetScenePath(string name)
        {
            return Utility.Text.Format("Assets/Scene/{0}.unity", name);
        }
        public static string GetEntityPath(string name)
        {
            return Utility.Text.Format("Assets/Prefabs/Entity/{0}.prefab", name);
        }

        public static string GetUIFormPath(string v)
        {
            return Utility.Text.Format("Assets/Prefabs/UI/{0}.prefab", v);
        }

        public static string GetTexturePath(string fileName)
        {
            return Utility.Text.Format("Assets/Textures/{0}", fileName);
        }
        public static string GetSpritesPath(string fileName)
        {
            return Utility.Text.Format("Assets/Sprites/{0}", fileName);
        }
        public static string GetConfigPath(string v)
        {
            return Utility.Text.Format("Assets/Config/{0}.txt", v);
        }
        public static string GetScriptableConfigPath(string v)
        {
            return Utility.Text.Format("Assets/ScriptableAssets/{0}.asset", v);
        }

        public static string GetPrefab(string v)
        {
            return Utility.Text.Format("Assets/Prefabs/{0}.prefab", v);
        }

        public static string GetLanguagePath(string v)
        {
            return Utility.Text.Format("Assets/Language/{0}.json", v);
        }
        public static string GetMaterialPath(string v)
        {
            return Utility.Text.Format("Assets/Material/{0}.mat", v);
        }

        public static string GetHotfixDll(string dllName)
        {
            return Utility.Text.Format("Assets/HotfixDlls/{0}.bytes", dllName);
        }
        ...
        public static string GetAnimAsset(string v)
        {
            return Utility.Text.Format("Assets/Anim/{0}", v);
        }
    }
    public class Json
    {
