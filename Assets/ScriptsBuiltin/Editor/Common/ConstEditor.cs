...
namespace UGF.EditorTools
{
    ...
    public class ConstEditor
    {
        ...
        public const string UIViewScriptFile = "Assets/Scripts/UI/Core/UIViews.cs";
        public const string UISerializeFieldDir = "Assets/Scripts/UI/UIVariables";//生成UI变量代码目录
        ...
        public const string ConstGroupScriptFileFullName = "Assets/Scripts/Common/Core/Const.Groups.cs";

        public static readonly string PrefabsPath = "Assets/Prefabs";
        public static readonly string ScenePath = "Assets/Scene";

        public const string DataTableCodeTemplate = "Assets/ScriptsBuiltin/Editor/DataTableGenerator/DataTableCodeTemplate/DataTableCodeTemplate.txt"; //生成配置表代码的模板文件
        public const string BuiltinAssembly = "Assets/ScriptsBuiltin/Runtime/Builtin.Runtime.asmdef";
        public const string HotfixAssembly = "Assets/Scripts/Hotfix.asmdef";


        public const string SharedAssetBundleName = "SharedAssets";//AssetBundle分包共用资源
        public static readonly string[] DefaultLayers = { "UI" };
        internal static readonly string KeystorePass = "kirameow";
        internal static readonly string KeyAliasPass = "kirameow";
        ...
        /// 数据表Excel目录
        /// </summary>
        public static string DataTableExcelPath => UtilityBuiltin.AssetsPath.GetCombinePath(Directory.GetParent(Application.dataPath).FullName, "Excel/DataTables");
        /// <summary>
        /// 配置表Excel目录
        /// </summary>
        public static string ConfigExcelPath => UtilityBuiltin.AssetsPath.GetCombinePath(Directory.GetParent(Application.dataPath).FullName, "Excel/Configs");
        /// <summary>
        /// 语言国际化Excel目录
        /// </summary>
        public static string LanguageExcelPath => UtilityBuiltin.AssetsPath.GetCombinePath(Directory.GetParent(Application.dataPath).FullName, "Excel/Languages");
        ...
        public const string DataTablePath = "Assets/DataTable";
        public const string GameConfigPath = "Assets/Config";
        public const string LanguagePath = "Assets/Language";
        public const string DataTableCodePath = "Assets/Scripts/DataTable";
    }
}
#endif